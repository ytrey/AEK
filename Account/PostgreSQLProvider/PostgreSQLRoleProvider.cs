...
namespace ActiveWeb.Providers
{
    ...
    public sealed class NpgsqlRoleProvider : RoleProvider
    {
        ...
        public override void Initialize(string name, NameValueCollection config)
        {
            ...
            pConnectionStringSettings = ConfigurationManager.ConnectionStrings["KUTAAuditConnectionString"];
            ...
            try
            {
                ...
                foreach (string username in usernames)
                {
                    foreach (string rolename in rolenames)
                    {
                        ...
                        temp.CreateEventInLog(ECA.Core.EventsLog.EventTypes.UserManagmentEvent, "Установка пользователю \"" + username + "\" роли \"" + rolename + "\"", ""); 
                    }
                }
