<%@ Page Title="Выполнить вход" Language="C#" MasterPageFile="~/Light.master" AutoEventWireup="true"
    CodeBehind="Login.aspx.cs" Inherits="ECA.Account.Login" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <asp:Login ID="LoginUser" runat="server" EnableViewState="false" RenderOuterTable="false" OnLoggingIn="OnLoggingIn" OnLoggedIn="OnLoggedIn">
        <LayoutTemplate>
