<%@ Page Title="Смена пароля" Language="C#" MasterPageFile="~/Light.master" AutoEventWireup="true"
    CodeBehind="ChangePassword.aspx.cs" Inherits="ECA.Account.ChangePassword" %>
                ...
                <fieldset class="changePassword">
                    ...
                    <p>
                        ...
                        <%--<asp:RegularExpressionValidator ID="PasswordRegularExpressionValidator" runat="server" ErrorMessage="Необходимо ввести более сложный пароль."  
                             CssClass="failureNotification" ControlToValidate="NewPassword" 
                             ValidationExpression="((?=^.{8,}$)((?=.*\d)|(?=.*\W+))(?![.\n])((?=.*[A-Z])|(?=.*[А-Я]))((?=.*[а-я])|(?=.*[a-z])).*$)" 
                             Visible="true" Style="text-indent: 20px" ValidationGroup="ChangeUserPasswordValidationSummary">Простой пароль
