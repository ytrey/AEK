<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.master" CodeBehind="uza.aspx.cs" Inherits="DXWebApplication1._uza" %>
...
<dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="XpoDataSource1" ClientInstanceName="ASPxGridView1"
    ...
    <Columns>
        <dx:GridViewCommandColumn Caption="Редактирование" ShowEditButton="True" VisibleIndex="7" ShowDeleteButton="True" ShowNewButtonInHeader="True">
            <HeaderStyle HorizontalAlign="Center" Wrap="True" />
        </dx:GridViewCommandColumn>
        <dx:GridViewDataTextColumn FieldName="is_active" Visible="False" VisibleIndex="12">
        </dx:GridViewDataTextColumn>
        <dx:GridViewDataTextColumn FieldName="main_type" Visible="False" VisibleIndex="9">
        </dx:GridViewDataTextColumn>
        <dx:GridViewDataTextColumn FieldName="div_code" Visible="False" VisibleIndex="10">
        </dx:GridViewDataTextColumn>
        <dx:GridViewDataTextColumn FieldName="main_id" ReadOnly="True" Visible="False" VisibleIndex="8">
        </dx:GridViewDataTextColumn>
        ...
        <dx:GridViewDataTextColumn FieldName="expl_km" Visible="False" VisibleIndex="11">
        </dx:GridViewDataTextColumn>
        <dx:GridViewBandColumn Caption="Местоположение задвижки" Name="Местоположение задвижки" VisibleIndex="0">
            <Columns>
        ...
        <dx:GridViewDataHyperLinkColumn Caption="Файл" FieldName="file_name" VisibleIndex="6">
...
<dx:XpoDataSource ID="XpoDataSource1" runat="server" DefaultSorting="" TypeName="DXWebApplication1.DataModel.KUTA_ECA.uza">
</dx:XpoDataSource>
